...
def getCurrentTemperature():
    ...
    return jsonify({'Current_Tempertature' : currentTemp})
...
def getNextOneVariableAuto():
    ...
    dt_list,size_tran,slope,intercept,std_err = myCal.PredictTemperatureWithOneVariale("temperature")
    return jsonify({'Current_Tempertature' : currentTemperature, 'Next_Temperature' : myCal.fx(currentTemperature,slope,intercept)})
...
def getNextTwoVariableAuto():
    ...
    dt_firstList,dt_secondList,size_tran,a,b,c = myCal.PredictTemperatureWithTwoVariale("temperature","humidity")
    return jsonify({"Current_Tempertature":currentTemperature,"Current_Humidity":currentHumidity,'Next_Temperature' : myCal.f(currentTemperature,currentHumidity,a,b,c)})
